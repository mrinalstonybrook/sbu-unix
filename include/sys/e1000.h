...
extern struct e1000_tx_desc trans_desc[256];
extern struct trans_data_buffer trans_buf[256];
...
struct recv_data_buffer{
char buf[2048];
};

extern struct e1000_rx_desc recv_desc[256];
extern struct recv_data_buffer recv_buf[256];
